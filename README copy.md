...
> Because it's not a github public repo

1. Configure your git client

```sh
git config --global url."git@craft.f.krux:".insteadOf "https://craft.f.krux/git/"
```

2. Get the package

```sh
GOPRIVATE=craft.f.krux/* go get -v  github.com/tuxounet/k2-sdk
```
...
init:
	GOPRIVATE=craft.in.krux.lan/* go get -v
...
import (
	"craft.f.krux/git/infra/k-hello.git/app"
...
### Sample controller (controlles/hello/controller.go)
...
import (
	"craft.f.krux/git/infra/k-hello.git/controllers/hello"
	"craft.f.krux/git/infra/k-hello.git/docs"
	"craft.f.krux/git/infra/k-hello.git/ui"
	"github.com/tuxounet/k2-sdk/bases"
	"github.com/tuxounet/k2-sdk/types"
)
